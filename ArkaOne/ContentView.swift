...
struct ContentView: View {
    ...
    var body: some View {
        VStack {
            ...
            if(isLoggedIn) {
                HStack {
                    createNavigationLinkButton(destination: EmptyView(), imageName: "ClockPlus", buttonText: "Masuk", textColor: .white, buttonWidth: 166, buttonHeight: 40, buttonColor: Color(red: 168/255, green: 122/255, blue: 71/255))

                    createNavigationLinkButton(destination: EmptyView(), imageName: "ClockCheck", buttonText: "Pulang", textColor: Color(red: 168/255, green: 122/255, blue: 71/255), buttonWidth: 166, buttonHeight: 40, buttonColor: .white)
                }
//                .padding(.top, -25)
            }
        }
